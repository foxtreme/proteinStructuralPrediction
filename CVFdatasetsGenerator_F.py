...
f1 = open("sources/family_level/lff1comp_U30.txt","r")
lines = f1.readlines()
f1.close()

#load all proteins and their classification - test
f3 = open("sources/family_level/lff1_U30.txt","r")
lines2 = f3.readlines()
f3.close()
#training
training = list()
...
f2 = file("sources/family_level/trainingDataset-1_U30.arff","w")
...
f2.close()    
#header of the training file
f3 = file("sources/family_level/testDataset-1_U30.arff","w")
...
f3.write("@ATTRIBUTE class {b.34.2.1,b.34.2.0,c.3.1.5,d.108.1.1,a.104.1.0,c.67.1.0,c.93.1.0,c.94.1.1,c.94.1.0,c.2.1.0,c.2.1.3,c.2.1.2,d.15.1.1,b.36.1.0,b.36.1.1,d.144.1.0,d.144.1.7,b.40.4.5,c.1.11.0,c.37.1.19,c.14.1.0,c.66.1.0,c.108.1.0,c.47.1.0,a.121.1.1,c.23.1.0,d.58.7.0,d.58.7.1,b.1.2.1,b.55.1.1,g.37.1.1,c.37.1.8,b.1.1.1,c.69.1.0,a.4.5.0,a.4.1.9,g.39.1.3,c.37.1.0,c.37.1.1,b.1.1.0,b.1.1.4} \n")
f3.write("@DATA\n")
